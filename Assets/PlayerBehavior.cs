...
public class PlayerBehavior : MonoBehaviour
{
    ...
    public float xMovementDirection = 0;
    [SerializeField] private ButtonDetector leftButton;
    [SerializeField] private ButtonDetector rightButton;
    ...
    private void Move()
    {
        if (leftButton.IsButtonDown()) xMovementDirection = -1;
        else if (rightButton.IsButtonDown()) xMovementDirection = 1;
        else xMovementDirection = 0;
